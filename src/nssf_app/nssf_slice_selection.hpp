...
class nssf_slice_select {
 private:
  ...
  static bool get_valid_amfset(
      const std::vector<oai::_3gpp::model::Snssai>& req_nssai,
      AuthorizedNetworkSliceInfo& auth_slice_info);

  static bool get_valid_amf(
      const std::vector<oai::_3gpp::model::ExtSnssai> e_snssai_list,
      const std::vector<oai::_3gpp::model::Snssai> r_nssai);
  static void set_allowed_nssai(
      const std::vector<oai::_3gpp::model::Snssai> nssai,
      AuthorizedNetworkSliceInfo& auth_slice_info);
  static bool compare_snssai(
      const oai::_3gpp::model::Snssai a, const oai::_3gpp::model::Snssai b);
  static bool validate_ta(
      const oai::_3gpp::model::Tai tai,
      std::vector<oai::_3gpp::model::Snssai> rejected_snssai);
  static bool validate_ta(const oai::_3gpp::model::Tai& tai);
