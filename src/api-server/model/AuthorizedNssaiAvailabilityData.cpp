...
std::vector<ExtSnssai> AuthorizedNssaiAvailabilityData::getSupportedSnssaiList() const
{
    return m_SupportedSnssaiList;
}
void AuthorizedNssaiAvailabilityData::setSupportedSnssaiList(std::vector<ExtSnssai> const& value)
{
    m_SupportedSnssaiList = value;
}
std::vector<RestrictedSnssai> AuthorizedNssaiAvailabilityData::getRestrictedSnssaiList() const
{
    return m_RestrictedSnssaiList;
}
void AuthorizedNssaiAvailabilityData::setRestrictedSnssaiList(std::vector<RestrictedSnssai> const& value)
{
...
void AuthorizedNssaiAvailabilityData::setTaiList(std::vector<Tai> const& value)
{
    m_TaiList = value;
    m_TaiListIsSet = true;
}
...
void AuthorizedNssaiAvailabilityData::setTaiRangeList(std::vector<TaiRange> const& value)
{
