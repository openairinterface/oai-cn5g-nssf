...
bool NssfEventSubscriptionCreatedData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<AuthorizedNssaiAvailabilityData>& value = m_AuthorizedNssaiAvailabilityData;
...
std::vector<AuthorizedNssaiAvailabilityData> NssfEventSubscriptionCreatedData::getAuthorizedNssaiAvailabilityData() const
{
    return m_AuthorizedNssaiAvailabilityData;
}
void NssfEventSubscriptionCreatedData::setAuthorizedNssaiAvailabilityData(std::vector<AuthorizedNssaiAvailabilityData> const& value)
{
