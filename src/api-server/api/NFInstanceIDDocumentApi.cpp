...
void NFInstanceIDDocumentApi::setupRoutes() {
    ...
    Routes::Delete(*router, base + "/nssai-availability/:nfId", Routes::bind(&NFInstanceIDDocumentApi::n_ssai_availability_delete_handler, this));
    Routes::Patch(*router, base + "/nssai-availability/:nfId", Routes::bind(&NFInstanceIDDocumentApi::n_ssai_availability_patch_handler, this));
    Routes::Put(*router, base + "/nssai-availability/:nfId", Routes::bind(&NFInstanceIDDocumentApi::n_ssai_availability_put_handler, this));
...
void NFInstanceIDDocumentApi::n_ssai_availability_delete_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
...
void NFInstanceIDDocumentApi::n_ssai_availability_patch_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
    ...
    try {
        this->n_ssai_availability_patch(nfId, patchItem, contentEncoding, acceptEncoding, response);
    } catch (Pistache::Http::HttpError &e) {
        response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
        return;
    } catch (std::exception &e) {
...
void NFInstanceIDDocumentApi::n_ssai_availability_put_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
    ...
    try {
        this->n_ssai_availability_put(nfId, nssaiAvailabilityInfo, contentEncoding, acceptEncoding, response);
    } catch (Pistache::Http::HttpError &e) {
        response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
        return;
    } catch (std::exception &e) {
