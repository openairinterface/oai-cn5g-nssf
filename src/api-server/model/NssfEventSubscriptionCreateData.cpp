...
void NssfEventSubscriptionCreateData::setTaiList(std::vector<Tai> const& value)
{
    m_TaiList = value;
}
...
void NssfEventSubscriptionCreateData::setTaiRangeList(std::vector<TaiRange> const& value)
{
