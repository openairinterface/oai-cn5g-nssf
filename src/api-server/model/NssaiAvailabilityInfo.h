...
public:
    ...
    /// 
    /// </summary>
    std::vector<SupportedNssaiAvailabilityData> getSupportedNssaiAvailabilityData() const;
    void setSupportedNssaiAvailabilityData(std::vector<SupportedNssaiAvailabilityData> const& value);
    /// <summary>
    /// 
    /// </summary>
