...
std::vector<SubscribedSnssai> SliceInfoForRegistration::getSubscribedNssai() const
{
    return m_SubscribedNssai;
}
void SliceInfoForRegistration::setSubscribedNssai(std::vector<SubscribedSnssai> const& value)
{
...
void SliceInfoForRegistration::setAllowedNssaiCurrentAccess(AllowedNssai const& value)
{
...
void SliceInfoForRegistration::setAllowedNssaiOtherAccess(AllowedNssai const& value)
{
...
void SliceInfoForRegistration::setSNssaiForMapping(std::vector<Snssai> const& value)
{
...
void SliceInfoForRegistration::setRequestedNssai(std::vector<Snssai> const& value)
{
...
std::vector<MappingOfSnssai> SliceInfoForRegistration::getMappingOfNssai() const
{
    return m_MappingOfNssai;
}
void SliceInfoForRegistration::setMappingOfNssai(std::vector<MappingOfSnssai> const& value)
{
