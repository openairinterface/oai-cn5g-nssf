...
private:
    ...
    void n_ssai_availability_post_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    /// 
    /// </remarks>
    /// <param name="nssfEventSubscriptionCreateData">Subscription for notification about updates to NSSAI availability information</param>
    /// <param name="contentEncoding">Content-Encoding, described in IETF RFC 7231 (optional, default to &quot;&quot;)</param>
    virtual void n_ssai_availability_post(const oai::nssf_server::model::NssfEventSubscriptionCreateData &nssfEventSubscriptionCreateData, const Pistache::Optional<Pistache::Http::Header::Raw> &contentEncoding, Pistache::Http::ResponseWriter &response) = 0;
