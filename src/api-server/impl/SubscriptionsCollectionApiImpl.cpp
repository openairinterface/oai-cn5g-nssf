...
void SubscriptionsCollectionApiImpl::n_ssai_availability_post(const NssfEventSubscriptionCreateData &nssfEventSubscriptionCreateData, const Pistache::Optional<Pistache::Http::Header::Raw> &contentEncoding, Pistache::Http::ResponseWriter &response) {
