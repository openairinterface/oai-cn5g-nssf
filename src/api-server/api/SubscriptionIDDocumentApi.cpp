...
const std::string SubscriptionIDDocumentApi::base = "/nnssf-nssaiavailability/v1";
...
void SubscriptionIDDocumentApi::setupRoutes() {
    ...
    Routes::Patch(*router, base + "/nssai-availability/subscriptions/:subscriptionId", Routes::bind(&SubscriptionIDDocumentApi::n_ssai_availability_sub_modify_patch_handler, this));
    Routes::Delete(*router, base + "/nssai-availability/subscriptions/:subscriptionId", Routes::bind(&SubscriptionIDDocumentApi::n_ssai_availability_unsubscribe_handler, this));
...
void SubscriptionIDDocumentApi::n_ssai_availability_sub_modify_patch_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
    ...
    try {
        this->n_ssai_availability_sub_modify_patch(subscriptionId, patchItem, contentEncoding, response);
...
void SubscriptionIDDocumentApi::n_ssai_availability_unsubscribe_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    try {
