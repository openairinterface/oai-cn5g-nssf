...
bool NssaiAvailabilityInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* SupportedNssaiAvailabilityData */ {
        const std::vector<SupportedNssaiAvailabilityData>& value = m_SupportedNssaiAvailabilityData;
...
std::vector<SupportedNssaiAvailabilityData> NssaiAvailabilityInfo::getSupportedNssaiAvailabilityData() const
{
    return m_SupportedNssaiAvailabilityData;
}
void NssaiAvailabilityInfo::setSupportedNssaiAvailabilityData(std::vector<SupportedNssaiAvailabilityData> const& value)
{
