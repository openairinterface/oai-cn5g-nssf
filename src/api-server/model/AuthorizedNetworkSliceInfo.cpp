...
std::vector<AllowedNssai> AuthorizedNetworkSliceInfo::getAllowedNssaiList() const
{
    return m_AllowedNssaiList;
}
void AuthorizedNetworkSliceInfo::setAllowedNssaiList(std::vector<AllowedNssai> const& value)
{
...
std::vector<ConfiguredSnssai> AuthorizedNetworkSliceInfo::getConfiguredNssai() const
{
    return m_ConfiguredNssai;
}
void AuthorizedNetworkSliceInfo::setConfiguredNssai(std::vector<ConfiguredSnssai> const& value)
{
...
void AuthorizedNetworkSliceInfo::setRejectedNssaiInPlmn(std::vector<Snssai> const& value)
{
...
void AuthorizedNetworkSliceInfo::setRejectedNssaiInTa(std::vector<Snssai> const& value)
{
...
void AuthorizedNetworkSliceInfo::setNsiInformation(NsiInformation const& value)
{
