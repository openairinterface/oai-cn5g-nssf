...
std::vector<ExtSnssai> SupportedNssaiAvailabilityData::getSupportedSnssaiList() const
{
    return m_SupportedSnssaiList;
}
void SupportedNssaiAvailabilityData::setSupportedSnssaiList(std::vector<ExtSnssai> const& value)
{
...
void SupportedNssaiAvailabilityData::setTaiRangeList(std::vector<TaiRange> const& value)
{
